...
public class Email {
    private static final String FROM = "tanya.kupreeva91@gmail.com";
    private static final String PASSWORD = "tnnivbfoyfpeeqxn";
...
//          message.setContent(msg, "text/html");
    ...
    public static void main(String[] args) {
        ...
        String subj = "NO SPAM!";
        String msg = "<a href = 'https://onliner.by'>SPAM2</a>";
        HTMLTableBuilder tableBuilder = new HTMLTableBuilder("HTML Table" + msg, true, 3, 3,
                10, 10, 10);
        tableBuilder.addTableHeader("Company", "Contact", "Country");
        tableBuilder.addRowValues("company1", "Ivan", "Germany");
        tableBuilder.addRowValues("company2", "Alex", "England");

        send(FROM, subj, tableBuilder.build(), "/Users/tatyanakupreeva/web/pom.xml");
