...
public class HTMLTableBuilder {
    ...
    public HTMLTableBuilder(String header, boolean border, int rows, int columns, int fontHeaderSize, int fontRowSize, int fontColumnSize) {
        ...
        main.org.example.servlets.util.HTMLTableBuilder.fontHeaderSize = fontHeaderSize;
        main.org.example.servlets.util.HTMLTableBuilder.fontRowSize = fontRowSize;
        main.org.example.servlets.util.HTMLTableBuilder.fontColumnSize = fontColumnSize;
        if (header != null) {
            table.append("<b>");
            table.append(header);
            table.append("</b>");
